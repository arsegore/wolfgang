                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card shadow-sm h-100">
                            ...
                            <div class="card-footer bg-white border-0 p-3">
                                <a href="${pageContext.request.contextPath}/composition?id=${comp.id}" class="btn btn-primary w-100">Ouvrir</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
            ...
            <div class="col-md-4 mb-4">
                <div class="card shadow-sm border-0 bg-light h-100">
                    ...
                    <div class="card-footer bg-transparent border-0 p-3">
                        <a href="${pageContext.request.contextPath}/composition?id=${pub.id}" class="btn btn-outline-secondary w-100">Consulter</a>
                    </div>
                </div>
            </div>
        </c:forEach>
